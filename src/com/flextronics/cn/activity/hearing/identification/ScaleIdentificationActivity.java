...
import com.flextronics.cn.activity.hearing.identification.scale.FolkMusicActivity;
import com.flextronics.cn.activity.hearing.identification.scale.ForeignMusicActivity;
import com.flextronics.cn.util.HearingConstants;

public class ScaleIdentificationActivity extends BaseActivity {
	/**
	 * 设置当前页面的LOG打印标签
	 */
	public static final String TAG = "ScaleIdentificationActivity";
	...
	public void setupView() {
		...
		leftBottomTextView3.setText(R.string.hearing_system_identification_training_scale);
