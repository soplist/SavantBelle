...
public class PercussionActivity extends BaseActivity {
	...
	private void setupView(){
		//设置title的值
		setTrainingTitle(getString(R.string.hearing_system_identification_training_musical_instruments_percussion));
		//显示用户姓名
	...
	private void setupListener(){
		...
		musicalInstrumentsListView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				musicalInstrumentsType=MusicalInstruments.PercussionScale.ARRAY[position];
		...
		setOnBackButtonTouchListener(new OnTouchListener() {
			public boolean onTouch(View v, MotionEvent event) {
				if(event.getAction()==MotionEvent.ACTION_UP){
					startActivity(new Intent(PercussionActivity.this,MusicalInstrumentsIdentificationActivity.class));
					adapter.clear();
					finish();
				}
				return false;
	...
	private void drawRightFrameLayout(){
		...
		adapter=new MusicalInstrumentsAdapter(this,true,MusicalInstruments.PercussionScale.ARRAY);
