...
public class FolkMusicActivity extends BaseActivity {
	...
	private void setupView(){
		//设置title的值
		setTrainingTitle(getString(R.string.hearing_system_identification_training_musical_instruments_folk_music));
		//显示用户姓名
		...
		setOnBackButtonTouchListener(new OnTouchListener() {
			public boolean onTouch(View v, MotionEvent event) {
				if(event.getAction()==MotionEvent.ACTION_UP){
					startActivity(new Intent(FolkMusicActivity.this,MusicalInstrumentsIdentificationActivity.class));
					finish();
				}
				return false;
			}
	...
	private void drawRightFrameLayout(){
		...
		adapter=new MusicalInstrumentsAdapter(this,true,MusicalInstruments.FolkMusicScale.ARRAY);
