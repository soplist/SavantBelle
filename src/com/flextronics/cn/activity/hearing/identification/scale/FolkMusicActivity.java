...
public class FolkMusicActivity extends BaseActivity{
	//声明一个常量
	private static final int LAYOUT_ID_ONE=100;
	//声明一个常量
	private static final int LAYOUT_ID_TWO=101;
	//声明一个常量
	private static final int LAYOUT_ID_THREE=102;
	//声明一个常量
	private static final int LAYOUT_ID_FOUR=103;
	//声明一个常量
	private static final int LAYOUT_ID_FIVE=104;
	//声明一个常量
	private static final int LAYOUT_ID_SIX=105;
	//声明一个常量
	private static final int VIEW_ID_ONE=200;
	//声明一个常量
	private static final int VIEW_ID_TWO=201;
	//声明一个常量
	private static final int VIEW_ID_THREE=202;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		displayLayout.setId(LAYOUT_ID_ONE);
	...
	private void setupView(){
		//设置title的值
		setTrainingTitle(getString(R.string.hearing_system_identification_training_scale_folk_music));
		//显示用户姓名
	...
	private void setupListener(){
		...
		musicalInstrumentsListView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				musicalInstrumentsType=MusicalInstruments.FolkMusicScale.ARRAY[position];
	...
	private void drawTopFrameLayout(){
		...
		//设定Frame的在父框架中的布局规则
		params.addRule(RelativeLayout.CENTER_HORIZONTAL, LAYOUT_ID_ONE);
		//实例化topFrameLayout对象
		topFrameLayout=new RelativeLayout(this);
		//给frameLayout对象设置唯一的ID号
		topFrameLayout.setId(LAYOUT_ID_TWO);
		//给frameLayout设定背景图片
	...
	private void drawLeftFrameLayout(){
		...
		params.addRule(RelativeLayout.ALIGN_PARENT_LEFT, LAYOUT_ID_TWO);
		//设定imageView的大小
		RelativeLayout.LayoutParams params2=new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,RelativeLayout.LayoutParams.WRAP_CONTENT);
		//设定imageView距上边距的距离为5dip
		params2.topMargin=5;
		//设定imageView的在父框架中的布局规则
		params2.addRule(RelativeLayout.CENTER_HORIZONTAL, LAYOUT_ID_THREE);
		//实例化leftFrameLayout对象
		leftFrameLayout=new RelativeLayout(this);
		//给leftFrameLayout对象设置唯一的ID号
		leftFrameLayout.setId(LAYOUT_ID_THREE);
		//实例化detailView对象
	...
	private void drawRightFrameLayout(){
		...
		params.addRule(RelativeLayout.RIGHT_OF, LAYOUT_ID_THREE);
		...
		//给leftFrameLayout对象设置唯一的ID号
		rightFrameLayout.setId(LAYOUT_ID_FOUR);
		...
		musicalInstrumentsAdapter=new MusicalInstrumentsAdapter(this,true,MusicalInstruments.FolkMusicScale.ARRAY);
	...
	private void drawBottomFrameLayout(){
		...
		params.addRule(RelativeLayout.BELOW, LAYOUT_ID_FIVE);
		//设定bottomFrameLayout的在父框架中的布局规则
		params.addRule(RelativeLayout.CENTER_HORIZONTAL, LAYOUT_ID_ONE);
		...
		params2.addRule(RelativeLayout.LEFT_OF, VIEW_ID_TWO);
		//设定singleToneButton的在父框架中的布局规则
		params2.addRule(RelativeLayout.CENTER_IN_PARENT, LAYOUT_ID_SIX);
		//设定continueToneButton的大小
		RelativeLayout.LayoutParams params3=new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,RelativeLayout.LayoutParams.WRAP_CONTENT);
		//设定continueToneButton的在父框架中的布局规则
		params3.addRule(RelativeLayout.CENTER_IN_PARENT, LAYOUT_ID_SIX);
		//设定complexToneButton的大小
		RelativeLayout.LayoutParams params4=new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT,RelativeLayout.LayoutParams.WRAP_CONTENT);
		params4.leftMargin=20;
		//设定complexToneButton的在父框架中的布局规则
		params4.addRule(RelativeLayout.RIGHT_OF, VIEW_ID_TWO);
		//设定complexToneButton的在父框架中的布局规则
		params4.addRule(RelativeLayout.CENTER_IN_PARENT, LAYOUT_ID_SIX);
		//实例化bottomFrameLayout对象
		bottomFrameLayout=new RelativeLayout(this);
		//给bottomFrameLayout对象设置唯一的ID号
		bottomFrameLayout.setId(LAYOUT_ID_SIX);
		...
		singleToneButton.setId(VIEW_ID_ONE);
		...
		continueToneButton.setId(VIEW_ID_TWO);
		...
		complexToneButton.setId(VIEW_ID_THREE);
	...
	private void drawPlayView(){
		...
		params.addRule(RelativeLayout.BELOW,LAYOUT_ID_SIX);
		//设定playView的在父框架中的布局规则
		params.addRule(RelativeLayout.CENTER_HORIZONTAL, LAYOUT_ID_ONE);
		//实例化playView对象
